    ...
    int nCmdShow)
{
    ...
    HWND hWnd;
    // this struct holds information for the windos class
    WNDCLASSEX wc;
    ...
    hWnd = CreateWindowEx(
        ...
        _T("Hellow Engine![Direct 2D]"), // title of the window
...
LRESULT CALLBACK WindowProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_PAINT:
    {
        ...
        if (SUCCEEDED(hr))
        {
            ...
            D2D1_SIZE_F rtSize = pRenderTarget->GetSize(); // draw a grid background.
